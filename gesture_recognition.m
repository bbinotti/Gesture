function [color, pos] = gesture_recognition(x, closest, prev_color, prev_pos)
...
%to blue).
%Inputs: segmented hand image (x), depth value of the hand (closest),
